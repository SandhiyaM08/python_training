#takes date of joining calculate days the employee been today and approximate nof of years and month

'''from datetime import date

year, month, date = map(int, input("Enter your date of joining (YYYY-MM-DD): ").split('-'))
