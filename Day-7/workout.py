...
tuple1 = (12344, 'sandhiya', 'sky12234', [1000, ],input("Enter credit or debit amount: "))
tuple1[4]= (tuple1[4]=='Credit' and tuple1[3][0]+int(input('Enter the amount:'))) or (tuple1[4]=='Debit' and tuple1[3][0]-int(input('Enter the amount:')))
print(tuple1)
